# 卡易 PPT 版式预设 Layout Presets v2.0
...
function loadAllAssets() {
  return {
    BG_COVER:       loadAsset('bg_cover.png'),
    BG_TOC:         loadAsset('bg_toc.png'),
    BG_SEC_A:       loadAsset('bg_section_a.png'),
    BG_SEC_B:       loadAsset('bg_section_b.png'),
    BG_SEC_C:       loadAsset('bg_section_c.png'),
    BG_CLOSING:     loadAsset('bg_closing.png'),
...
function addClosingSlide(pres, A, pageNum) {
  ...
  s.addText('版权所有 © 浙江卡易智慧医疗科技有限公司', { x:1.095, y:6.961, w:2.965, h:0.188, fontSize:8, color:'AACCDD', fontFace:'Microsoft YaHei', margin:0 });
 ...
 *   { label:'PaaS 层', color:'005392', items:['卡易影像云平台','Skill市场','Agent平台'] },
