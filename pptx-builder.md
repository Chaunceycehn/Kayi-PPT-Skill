# 卡易 PPT 技术构建规范 PPTX Builder v2.0
...
const REQUIRED = [
  ...
  'bg_cover.png', 'bg_toc.png',
  'bg_section_a.png', 'bg_section_b.png', 'bg_section_c.png',
  'bg_closing.png', 'closing_thanks.png'
];
...
| 章节页 | 大数字 125pt #2C5DB6 加粗；装饰横线 #2C5DB6，y=2.489"；标题 24pt 白色加粗；副标题 16pt 白色；全局字体 Microsoft YaHei |
